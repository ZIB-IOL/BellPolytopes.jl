...
Analyticity correction is disabled and the returned bounds are numerical.
...
function nonlocality_threshold(
        ...
        deflate = identity,
        inflate = identity,
        analyticity::Bool = !prob && !out && (o === nothing || _is_white_noise(o, marg)),
        verbose = 0,
        active_set = nothing,
        shortcut = 2,
    ...
    _, _, _, o, sym, deflate, inflate = _bfw_init(p, 0, prob, out, marg, o, sym, deflate, inflate, verbose > 0)
    if analyticity
